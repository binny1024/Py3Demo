...
def set_message(name, qq):
    ...
    #
    # try:
    #     print("查找主页是否有右侧的留言板模块")
    #     driver.find_element_by_id('QM_334_Accessory_TA').send_keys(name + """
    #     元旦快乐!
    #     python 自动留言脚本测试
    #     请自行删除--先抱歉为敬!
    #     """)
    #     if leave_msg:
    #         driver.find_element_by_id('QM_334_Accessory_SubmitBTN').click()
    #     waiting_for_page_finish(2)
    #     return
    # except Exception as e:
    #     print("主页右侧留言模块异常,跳过......")
    ...
    #     通过使用 xpath 查找元素
    #     """
    #     print("查找主页是否有左侧的留言板模块")
    #     driver.find_element_by_id("$1_substitutor_content").send_keys(name + """
    #               元旦快乐!
    #               python 自动留言脚本测试
    #               请自行删除--先抱歉为敬!
    #               """)
    #     # driver.find_element_by_xpath('//*[@id="$1_content_content"]').send_keys(name + """
    #     #       元旦快乐!
    #     #       python 自动留言脚本测试
    #     #       请自行删除--先抱歉为敬!
    #     #       """)
    ...
    # try:
    #     """
    #     通过主页的 留言板 入口 进入留言板截面
    #     """
    #     driver.find_element_by_link_text("留言板").click()
    #
    #     # 定位输入信息frame
    #     waiting_for_page_finish(3)
    #     print("找留言编辑框")
    #     iframe = driver.find_element_by_id("tgb")
    #     driver.switch_to.frame(iframe)
    #     driver.switch_to.frame("veditor1_Iframe")
